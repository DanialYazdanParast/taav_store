...
import 'package:example/src/pages/buyer/orders/widgets/order_details_summary_card.dart';
import 'package:example/src/pages/buyer/orders/widgets/order_item_card.dart';
...
class OrderDetailContent extends StatelessWidget {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: AppSize.brCircular(isDesktop ? AppSize.r12 : AppSize.r8),
            ),
            child: Icon(
              ...
              children: [
                Text(
                  ...
                  style: theme.textTheme.titleMedium?.copyWith(
                    ...
                    color: isDesktop ? theme.colorScheme.onSurfaceVariant : null,
                  ),
                  maxLines: 1,
  ...
  Widget _buildItemsHeader(ThemeData theme) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.shopping_basket_outlined, color: theme.colorScheme.primary, size: 24),
          AppSize.p12.width,
          Expanded(
            child: Text(
              TKeys.orderItems.tr,
          ...
          AppSize.p8.width,
          Container(
            padding: EdgeInsets.symmetric(horizontal: AppSize.p12, vertical: AppSize.p4),
            decoration: BoxDecoration(
              color: theme.colorScheme.primary.withValues(alpha: 0.1),
